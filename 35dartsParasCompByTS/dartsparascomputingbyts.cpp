...
void dartsParasComputingByTS::on_computeTall1PushButton_clicked()
{
    ...
    ui->Tall1LineEditOutput->insert(QString::number(ui->dart1F0LineEditInput->text().toDouble() + (((ui->mdart1PlusGLineEditInput->text().toDouble() + ui->mLauncherPlusGLineEditInput->text().toDouble()) * 9.8 / 1000 * (ui->xLineEdit->text().toDouble() + ui->dart1RelativeXLineEdit->text().toDouble() * 0.01) * (ui->xLineEdit->text().toDouble() + ui->dart1RelativeXLineEdit->text().toDouble() * 0.01) /( 4 * qCos(ui->setaLineEdit_2->text().toDouble()) * qCos(ui->setaLineEdit_2->text().toDouble()) * ((ui->xLineEdit->text().toDouble() + ui->dart1RelativeXLineEdit->text().toDouble() * 0.01) * qTan(ui->setaLineEdit_2->text().toDouble()) - ui->hLineEdit->text().toDouble()))) - ui->dart1IntegralOfF0PlusDxtensionLineEditInput->text().toDouble()) / ui->k1PlusXtensionLineEditInput->text().toDouble()));
}
...
void dartsParasComputingByTS::on_computeTall2PushButton_clicked()
{
    ...
    ui->Tall2LineEditOutput->insert(QString::number(ui->dart2F0LineEditInput->text().toDouble() + (((ui->mdart2PlusGLineEditInput->text().toDouble() + ui->mLauncherPlusGLineEditInput->text().toDouble()) * 9.8 / 1000 * (ui->xLineEdit->text().toDouble() + ui->dart2RelativeXLineEdit->text().toDouble() * 0.01) * (ui->xLineEdit->text().toDouble() + ui->dart2RelativeXLineEdit->text().toDouble() * 0.01) /( 4 * qCos(ui->setaLineEdit_2->text().toDouble()) * qCos(ui->setaLineEdit_2->text().toDouble()) * ((ui->xLineEdit->text().toDouble() + ui->dart2RelativeXLineEdit->text().toDouble() * 0.01) * qTan(ui->setaLineEdit_2->text().toDouble()) - ui->hLineEdit->text().toDouble()))) - ui->dart2IntegralOfF0PlusDxtensionLineEditInput->text().toDouble()) / ui->k1PlusXtensionLineEditInput->text().toDouble()));
}
...
void dartsParasComputingByTS::on_computeTall3PushButton_clicked()
{
    ...
    ui->Tall3LineEditOutput->insert(QString::number(ui->dart3F0LineEditInput->text().toDouble() + (((ui->mdart3PlusGLineEditInput->text().toDouble() + ui->mLauncherPlusGLineEditInput->text().toDouble()) * 9.8 / 1000 * (ui->xLineEdit->text().toDouble() + ui->dart3RelativeXLineEdit->text().toDouble() * 0.01) * (ui->xLineEdit->text().toDouble() + ui->dart3RelativeXLineEdit->text().toDouble() * 0.01) /( 4 * qCos(ui->setaLineEdit_2->text().toDouble()) * qCos(ui->setaLineEdit_2->text().toDouble()) * ((ui->xLineEdit->text().toDouble() + ui->dart3RelativeXLineEdit->text().toDouble() * 0.01) * qTan(ui->setaLineEdit_2->text().toDouble()) - ui->hLineEdit->text().toDouble()))) - ui->dart3IntegralOfF0PlusDxtensionLineEditInput->text().toDouble()) / ui->k1PlusXtensionLineEditInput->text().toDouble()));
}
...
void dartsParasComputingByTS::on_computeTall4PushButton_clicked()
{
    ...
    ui->Tall4LineEditOutput->insert(QString::number(ui->dart4F0LineEditInput->text().toDouble() + (((ui->mdart4PlusGLineEditInput->text().toDouble() + ui->mLauncherPlusGLineEditInput->text().toDouble()) * 9.8 / 1000 * (ui->xLineEdit->text().toDouble() + ui->dart4RelativeXLineEdit->text().toDouble() * 0.01) * (ui->xLineEdit->text().toDouble() + ui->dart4RelativeXLineEdit->text().toDouble() * 0.01) /( 4 * qCos(ui->setaLineEdit_2->text().toDouble()) * qCos(ui->setaLineEdit_2->text().toDouble()) * ((ui->xLineEdit->text().toDouble() + ui->dart4RelativeXLineEdit->text().toDouble() * 0.01) * qTan(ui->setaLineEdit_2->text().toDouble()) - ui->hLineEdit->text().toDouble()))) - ui->dart4IntegralOfF0PlusDxtensionLineEditInput->text().toDouble()) / ui->k1PlusXtensionLineEditInput->text().toDouble()));
}
